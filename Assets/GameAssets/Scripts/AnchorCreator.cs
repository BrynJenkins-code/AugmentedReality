...
public class AnchorCreator : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (m_RaycastManager.Raycast(touch.position, s_Hits, TrackableType.PlaneWithinPolygon))
        {
            ...
            GameObject model = Instantiate(m_AnchorPrefab, anchor.transform);
            model.name = m_AnchorPrefab.name; 
            ...
            else
            {
                ...
                //Change player mode to 'interact'
                m_InteractionManager.interactMode();
            }
